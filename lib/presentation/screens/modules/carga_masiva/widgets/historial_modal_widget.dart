...
class _HistorialModalContentState extends State<_HistorialModalContent> {
  ...
  void initState() {
    super.initState();
    _totalContado = widget.item.cantidadContada;
    _loadHistorial();
  }
  ...
  void _openEditDialog(BuildContext context, ExistenciaHistorialModel hist) {
    ...
    final bool isAutoGeneratedObs = hist.observacion != null &&
        (hist.observacion!.startsWith('Conteo acumulado') ||
         hist.observacion!.startsWith('Conteo modificado') ||
         hist.observacion!.startsWith('Prueba'));
    final String initialObs = isAutoGeneratedObs ? '' : (hist.observacion ?? '');
    ...
    final obsCtrl = TextEditingController(text: initialObs);
    bool isSaving = false;
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: const TextStyle(fontSize: 12, color: Color(0xFF64748B)),
                        hintText: 'Opcional (se generará automáticamente)',
          ...
          Expanded(
            child: FutureBuilder<dynamic>(
              ...
              builder: (context, snapshot) {
                ...
                if (items.isNotEmpty && _totalContado != items.first.cantidadContadaNueva) {
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    if (mounted) {
                      setState(() {
                        _totalContado = items.first.cantidadContadaNueva;
                      });
                    }
                  });
                }
